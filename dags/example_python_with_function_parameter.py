...
#------------------------------------ Change Details ------------------------------------------
# 07/30/2019 - Anup Kumar - Example of simple dag with python operator and with function paramters
#----------------------------------------------------------------------------------------------
...
dag = DAG(
    'Example_dag_python_with_function_parameter',
    default_args=default_args,
    description='Example of simple dag with python operator and with function paramters',
